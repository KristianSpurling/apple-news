...
class Component_Factory {
	...
	public static function initialize( $workspace, $settings, $styles, $layouts ) {
        ...
        self::register_component( 'logo'        ,   '\\Apple_Exporter\\Components\\Logo'           );
		...
		self::register_component( 'breadcrumbcover'        ,   '\\Apple_Exporter\\Components\\Breadcrumbcover'           );
		self::register_component( 'title'        ,   '\\Apple_Exporter\\Components\\Title'           );
		self::register_component( 'divider'           ,   '\\Apple_Exporter\\Components\\Divider'         );
